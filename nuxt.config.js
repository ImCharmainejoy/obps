...
module.exports = {
  ...
  */
  ...
  env: {
    API_URL: 'https://ocbostaging.poolreno.com/api', // waiting for the api xd
    VUE_API_URL: 'https://ocbostaging.poolreno.com/' // waiting for the file api xd
  },
  ...
  apollo: {
    clientConfigs: {
      default: {
        httpEndpoint: 'http://202.137.120.41:50506/api/admin/graphiql',
      }
    }
  },
    /*
